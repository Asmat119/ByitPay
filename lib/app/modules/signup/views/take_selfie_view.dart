            ...
            child: ConstrainedBox(
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                      const PrimaryText(title: "Take a selfie 🤳🏽", subTitle: "We’ll use it to verify your identity as a new user. Please take a photo for verification. ")
                  ,
                    const Spacer(),
          ...
          Positioned(
            ...
            child: Column(
              children: [
                ...
                const CustomText(text: "Center your face", fontSize: 24, fontWeight: FontWeight.bold, color: white,),
                const SizedBox(height: 24,),
                SizedBox(
                  width: MediaQuery.of(context).size.width - 41,
                  child: const CustomText(text: "Align your face to the center and take a selfie for verification purpose only. ",
                    ...
                    MaterialButton(
                      ...
                      child: Container(
                        ...
                        child:  Container(
                          ...
                          child: Icon(Icons.check_rounded, color: white,),
