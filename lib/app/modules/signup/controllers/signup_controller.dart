...
class SignupController extends GetxController {
  ...
  Rx<TextEditingController> streetEditingController =
  ...
  RxString msgText =
      "Lets start with some basic info. Please enter as it appears on your official ID."
          .obs;
  ...
  List<PersonalInfoModel> confirmLoanList = [
    ...
    PersonalInfoModel(title: "Home Address", subTitle: "Lot 107 Kings Ave, Atlanta GA, 30331 United States")
  ];
  ...
  bool stepTwoValid() {
    if (streetText.isNotEmpty && cityText.isNotEmpty) {
      return true;
    } else {
      return false;
    }
      ...
      case 4:
        {
          ...
          msgText.value =
              "Regulation requires us to verify your Tax Payer  Number to setup an account. ";
        }
        break;
      case 5:
        {
          ...
          msgText.value =
              "Please enter your email address and password to secure your account.";
        }
        break;
    }
  }
